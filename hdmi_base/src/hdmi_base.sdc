...
create_clock -name clk_hdmi_5x -period 1.347 [get_pins {u_timing/clkdiv_hdmi/clkdiv_inst/HCLKIN}]

# Pixel clock at CLKDIV primitive output.
create_generated_clock -name clk_hdmi -source [get_pins {u_timing/clkdiv_hdmi/clkdiv_inst/HCLKIN}] -divide_by 5 [get_pins {u_timing/clkdiv_hdmi/clkdiv_inst/CLKOUT}]
